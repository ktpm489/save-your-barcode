  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity onPress={this.openTestScreenView} accessible={true}>
          <Text style={styles.linkButton}>
            {'Open ES6 Class Component: Test Screen View'}
          </Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={this.openCameraView} accessible={true}>
          <Text style={styles.linkButton}>
            {'Open Camera'}
          </Text>
        </TouchableOpacity>
